...
function guardarModificacion() {
    ...
    fetch('/CaC-Movies/GestionUsuariosServlet', {
        ...
        body: JSON.stringify(usuario) // método en JavaScript que convierte un objeto JavaScript en una cadena JSON.
    })
        .then(response => response.json())
        .then(data => {
...
function eliminarUsuario(id) {
    ...
    // Devuelve true si el usuario hace click en "Aceptar" y false si hace click en "Cancelar".
